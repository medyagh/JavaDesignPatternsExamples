...
public class Main {
	public static void main(String[] args) {
		...
		Expr onePtwo = ExprFactory.newPlus(ExprFactory.newConst(1),
				ExprFactory.newConst(2));
		Expr threeMfour = ExprFactory.newMult(ExprFactory.newConst(3),
				ExprFactory.newConst(4));
